...
def triplet_loss_with_knn_exp(device='3', ckpt_prefix='Run01', lr=1e-3, pretrain_epochs=50, batch_all_epochs=30,
    ...
    if is_train_embedding_model:
        ...
        for epoch in range(1, batch_all_epochs + batch_hard_epochs + 1):
            ...
            train_loss, metrics = train_epoch(train_loader=train_batch_loader, model=model, loss_fn=cur_loss_fn,
